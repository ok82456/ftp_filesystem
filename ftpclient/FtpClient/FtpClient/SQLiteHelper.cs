    ...
    public class SQLiteHelper
    {
        ...
        {//"Data Source=Test.db3;Pooling=true;FailIfMissing=false";  
            get
            {
                ...
                string text = System.Configuration.ConfigurationManager.ConnectionStrings["sqlite"].ConnectionString;//ConfigurationManager.AppSettings["SQLiteConnectionString"];
        ...
        public static DataTable ExecuteDataTable(string commandText, params object[] paramList)
        {
            SQLiteCommand cmd = Conn.CreateCommand();
            cmd.CommandText = commandText;
            if (paramList != null)
